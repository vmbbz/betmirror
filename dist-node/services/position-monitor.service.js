export class PositionMonitorService {
    ...
    orderBookValidationInterval;
    onPositionInvalid;
    constructor(adapter, walletAddress, config, logger, onAutoCashout, onPositionInvalid) {
    ...
    async validateOrderBookExists(tokenId) {
        try {
