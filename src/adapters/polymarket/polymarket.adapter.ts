...
export class PolymarketAdapter implements IExchangeAdapter {
    ...
    /**
     * Provides the necessary auth headers for private WebSocket connections.
     * Required by services listening to private fill feeds.
     */
    public getAuthHeaders(): any {
        ...
        return {
            ...
            // Note: Sig and Timestamp are generated by SDK if needed, 
            // but for WS many implementations just need Key/Pass.
        };
    }
