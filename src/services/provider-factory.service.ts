...
export class ProviderFactory {
    ...
    private static initializationPromise: Promise<JsonRpcProvider> | null = null;
     ...
     */
    static async getSharedProvider(rpcUrl?: string): Promise<JsonRpcProvider> {
     ...
     */
    private static async initializeProvider(rpcUrl?: string): Promise<JsonRpcProvider> {
     ...
     */
    private static isHealthy(): boolean {
    ...
    static async healthCheck(): Promise<boolean> {
        if (!this.sharedProvider) return false;
